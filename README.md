...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/tocr)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/tocr
```

A live public deployment of this template is available at [https://tocr.templates.workers.dev](https://tocr.templates.workers.dev)
